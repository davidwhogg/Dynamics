...
Finally, what (formally) would have to be the size of the iron
projectile such that equation (3.16) would \emph{actually} hold?  To
find out, look up the viscosity of air and Stokes Law.  Again, your
answer will have a ``$\gg$'' or a ``$\ll$'' sign in it.  In that case,
would the atmospheric drag be negligible?
\end{problem}
