...
Choose an integrator step size that is small enough to make the integration accurate
...
Bonus (not for credit): Integrate with a first-order ``leapfrog'' integrator and
interpolate the (intermediate) y values to the locations of the x
values for plotting.
\end{problem}
